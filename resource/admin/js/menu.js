;(function(win, doc){
	...
	$plugins.mainNavi = {
        appendNavi: function() {
//            $("#inc_navi").load("/admin/include_navi.do", function(){
    ...
    $plugins.menuData = [
        {
            ...
            "name": "계열사/협력사 관리",
            "sub": [
                { "name": "계열사/협력사 관리", "url": "/admin/DBAD020101.do" }
            ]
        },
        {
            "num": 2,
            "name": "회원관리",
            "sub": [
                { "name": "회원계정 관리", "url": "/admin/DBAD030101.do" },
                { "name": "계정신청 현황", "url": "/admin/DBAD030201.do" },
                { "name": "신청반려 현황", "url": "/admin/DBAD030301.do" }
            ]
        },
        {
            "num": 3,
            "name": "CI Guide 관리",
            "sub": [
                { "name": "가이드메뉴 관리", "url": "/admin/DBAD040101.do" },
                { "name": "가이드페이지 관리", "url": "/admin/DBAD040201.do" }
            ]
        },
        {
            "num": 4,
            "name": "문의 관리",
            "sub": [
            	{ "name": "CI 적용 문의", "url": "/admin/DBAD050301.do" },
                { "name": "상표 사용 관련 문의", "url": "/admin/DBAD050101.do" },
                { "name": "신규 상표 출원 문의", "url": "/admin/DBAD050201.do" }
            ]
        },
        {
            "num": 5,
            "name": "상표권 침해신고 관리",
            "sub": [
                { "name": "상표권 침해신고 문의", "url": "/admin/DBAD060101.do" }
            ]
        },
        {
            "num": 6,
            "name": "게시판 관리",
            "sub": [
                { "name": "게시판", "url": "/admin/DBAD070101.do" }
            ]
        },
        {
            "num": 7,
            "name": "관리자 계정관리",
            "sub": [
                { "name": "관리자 계정관리", "url": "/admin/DBAD080101.do" }
            ]
        },
        {
            "num": 8,
            "name": "이용/통계 현황",
            "sub": [
                { "name": "접속자 이용현황", "url": "/admin/DBAD090101.do" },
                { "name": "CI가이드 이용현황", "url": "/admin/DBAD090201.do" },
                { "name": "문의/신고 이용현황", "url": "/admin/DBAD090301.do" }
            ]
        },
    ];
